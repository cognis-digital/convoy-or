#!/usr/bin/env sh
# Universal installer for convoy-or. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/convoy-or.git"
echo "Installing convoy-or ..."
